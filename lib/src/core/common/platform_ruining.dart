...
abstract class PlatformRuining {
  ...
  ///   runApp(const App());
  /// }
  static final isRealMacos = !kIsWeb && _defaultTargetPlatform == TargetPlatform.macOS;
  ...
  ///   runApp(const App());
  /// }
  static final isRealWindows = !kIsWeb && _defaultTargetPlatform == TargetPlatform.windows;
